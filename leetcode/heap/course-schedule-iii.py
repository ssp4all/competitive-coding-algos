...
Given n online courses represented by pairs (t,d), your task is to find the maximal number 
of courses that can be taken.
...
class Solution:
    def scheduleCourse(self, courses: List[List[int]]) -> int:
        if not courses or not courses[0]:   return 0
